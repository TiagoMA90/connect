...
const TermsOfService = ({ isOpen, onRequestClose }) => {
  return (
    ...
    >
      ...
      <p>Your privacy is important to us. Our Privacy Policy outlines how we collect, use, and disclose your personal information. By using the App, you consent that your data will be stored in Cloudinary.</p>
      <strong>3. User Content</strong>
      <p>You retain ownership of the content you post, share, or upload to the App ("User Content"). However, by posting User Content, you grant Connect a non-exclusive, worldwide, royalty-free, sublicensable, and transferable license to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, perform, and display such User Content in connection with operating and promoting the App.</p>
      <strong>4. Code of Conduct</strong>
      <p>You agree to use the App in a manner consistent with applicable laws and regulations and in accordance with these Terms. You shall not:</p>
      <ul>
          <li> Post, transmit, or share any User Content that is unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, or otherwise objectionable.</li>
          <li> Engage in any activity that could compromise the security or integrity of the App, its users, or systems.</li>
      ...
      <p>In no event shall Connect be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from your use of the App.</p>
      <strong>9. Modifications to Terms</strong>
      <p>Connect may modify these Terms at any time by posting the revised Terms on the App. Your continued use of the App constitutes acceptance of the modified Terms.</p>
      <strong>10. Governing Law</strong>
      <p>These Terms are governed by and construed in accordance with the law of principles.</p>
